...
if(NO_GIT)
  set(rev_date "Instant 80 Free Wrathfull and Shadowmourne")
  set(rev_hash "")
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"Instant 80 Free Wrathfull and Shadowmourne"\")
    set(rev_date "Instant 80 Free Wrathfull and Shadowmourne")
    set(rev_hash "")
    set(rev_branch "Archived")
  else()
